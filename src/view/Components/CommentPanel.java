...
public class CommentPanel extends JPanel{
    ...
    private void buildCommentsPanel(){
        ...
        ArrayList<String[]> comments = postController.getCommentsForPost(imageId);
        ...
        for(String[] comment: comments){
            ...
            ImageIcon profileIcon = new ImageIcon("resources/img/storage/profile/" + comment[0] + ".png");
            ...
            String timestampMessage = FileServices.getElapsedTime(comment[2]);
            if(!timestampMessage.equals("Just now")) {
                timestampMessage = FileServices.getElapsedTime(comment[2]) + " ago";
            }
